	...
	<section id="contact-us" class="front-page-section">
		...
		<div class="section-content">
			<div class="container">
                ...
                <!--Aqui va la prueba de doble contacto -->
						...
						<div class="row" style="margin-bottom: 45px;">
							<div class="col-sm-4">
								<div class="contact-us-box">
									...
									<div class="box-right">
										<?php if ( $address1 ): ?>
											<span class="box-right-row" data-customizer="contact-us-address-1">Edificio Don Emilio Bacardi , calle Monserrate #261 e/ San Juan de Dios y Empedrado, Habana Vieja , La habana ; Cuba</span>
										<?php endif; ?>
										<?php if ( $address2 ): ?>
											<span class="box-right-row" data-customizer="contact-us-address-2"><?php echo illdy_sanitize_html( $address2 ); ?></span>
										<?php endif; ?>
                ...
                <!--Aqui termina la prueba de doble contacto-->
				<div class="row">
					<div class="col-sm-12">
